...
This project includes a comprehensive **OpenAPI 3.0 specification** in the Postman collection:

- 📘 **View in Postman**: Import the collection from `OpenAPI/Bank API Reference Documentation.postman_collection.json`
- 🔧 **Interactive Testing**: All endpoints are pre-configured with examples
- 📊 **Complete Documentation**: Request/response schemas, error codes, and more

For programmatic access, you can also generate an OpenAPI YAML specification.
