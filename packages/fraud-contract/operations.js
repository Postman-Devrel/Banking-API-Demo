module.exports = [
  ...
  { method: 'get', path: '/_demo/v1/runs/{runId}/summary', operationId: 'getFraudRunSummary', tag: 'Demo Control', summary: 'Inspect safe deterministic run evidence', response: 'RunSummary', status: 200, admin: true },
