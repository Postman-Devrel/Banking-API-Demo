...
class Account {
  constructor(accountId, owner, balance = 0, currency, createdAt = new Date().toISOString().split('T')[0], accountType = 'STANDARD', ownerPrincipalId = null, deleted = false) {
    ...
    this.status = deleted ? 'INACTIVE' : 'ACTIVE';
  }
