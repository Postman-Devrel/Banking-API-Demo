...
class Transaction {
  constructor(transactionId, fromAccountId, toAccountId, amount, currency, createdAt = new Date().toISOString(), metadata = {}) {
    ...
    this.status = metadata.status || 'POSTED';
    this.description = metadata.description || null;
    this.beneficiaryName = metadata.beneficiaryName || null;
    this.channel = metadata.channel || null;
    this.deviceTrusted = metadata.deviceTrusted ?? null;
